...
public class SliderAdapters extends RecyclerView.Adapter<SliderAdapters.SliderViewHolder> {
    ...
    public SliderAdapters.SliderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SliderViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.componente_slider_item, parent, false));
    }
    ...
    public class SliderViewHolder extends RecyclerView.ViewHolder {
        ...
        public SliderViewHolder(@NonNull View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.Csi_ImageSlide);
        }
        ...
        void setImage(SliderItems sliderItems) {
            ...
            Glide.with(context).load(sliderItems.gatImage()).apply(requestOptions).into(imageView);
        }
    }
